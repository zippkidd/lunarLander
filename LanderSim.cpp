...
int main(void)
{
    ...
    os << endl << endl;
    os << "LUNAR LANDER" << endl << "Beginning landing procedure.........." << endl << "DIGBY wishes you good luck!";
    os << endl << endl;
    cout << endl << endl;
    cout << "LUNAR LANDER" << endl << "Beginning landing procedure.........." << endl << "DIGBY wishes you good luck!";
    cout << endl << endl;
    while (height > 0)
    {
